...
<body>
	...
	<div id="header" class="container-fluid">
		...
		<div class="event_header container wow rubberBand">
			<span>Ngay 20/10 - 30/10/2019</span><br/>
			<span style="font-size: 50px">Nhân ngày quốc tế phụ nữ  <br> sẽ khuyến mãi các khách hàng nữ 90%</span><br/>
				...
				<div class="col-md-3 col-sm-6">
					<a href="chitiet/${sanpham.getMasanpham()}">
						<div class="sanpham wow zoomIn">
							<img width="240px" alt="hinh" src='<c:url value="/resources/Image/sanpham/${sanpham.getHinhsanpham() }"/>' /><br/>
